...
import { updateListOrder } from "@main/actions/update-list-order";
import { updateCardOrder } from "@main/actions/update-card-order";
  ...
  const onDragEnd = (result: any) => {
    ...
    if (type === "card") {
      ...
      if (source.droppableId === destination.droppableId) {
        ...
        // Assign thse new listId to the moved card
